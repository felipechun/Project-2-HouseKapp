...
const inviteUser = (origUser, invited, groupId) => {
  ...
  transporter.sendMail({
    ...
    https://housekapp.herokuapp.com/${groupId}?email=${invited}`,
    html: `
    <h3>Hi, there!</h3>

    <p>${origUser} has invited you to his HouseKapp group!</p>

    <p>Please, click <a href="https://housekapp.herokuapp.com/${groupId}?email=${invited}">here</a> create your account and start sharing tasks and expenses!</p>`,
  });
};
